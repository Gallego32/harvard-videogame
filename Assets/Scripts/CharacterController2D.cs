...
public class CharacterController2D : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		if (OnCeilingCollision == null)
			OnCeilingCollision = new UnityEvent();
	}
	...
	private void FixedUpdate()
	{
		...
		// Check if we collide with the ceiling so we call ceiling collision event
		// We check collision with our CeilingCheck position and creating a collider. It returns a collider array
